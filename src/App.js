...
export default function App() {
  ...
  function generate() {
    const basePrompt = fillTemplate(templateText, samplePlaceholders);
    ...
    let finalPrompt = `${basePrompt} ${toneText} ${lengthText}`;

    if (Math.random() > 0.7) {
      finalPrompt += ' Add a quick example usage.';
    }
      ...
      <main className="panel main-panel">
        <div className="controls">
          <select
            ...
            onChange={(e) => {
              const t = TEMPLATES.find((x) => x.title === e.target.value);
              loadTemplate(t);
            }}
          >
            {TEMPLATES.map((t) => (
          ...
          <div className="resultCard">
            <div className="resultHeader">
              ...
              <div className="resultButtons">
                ...
                <button className="btn small transparent" onClick={downloadPrompt}>
                  Download
                </button>
              </div>
            </div>
